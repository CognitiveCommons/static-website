...
### Added
- Added a "What We Do" section that frames the work around Access, Agency, and Assurance, including concrete actions for each pillar.
- Added a six-step "How We Work" loop (Start small, Co-design, Ship, Measure, Publish, Replicate) with outcome-focused guidance.
- Added an `initiallyVisible` option to the `FadeIn` animation to keep hero content visible before scroll triggers.

### Changed
- Updated the hero headline to "We help small teams deliver outcomes" with a clearer mission statement and Atlantic Canada focus.
...
- Refined "What's Coming" to lead with the online course launch, followed by services, playbooks, and partner-led delivery.
...
- Updated site metadata titles, keywords, and Open Graph summary to align with the refreshed messaging.
